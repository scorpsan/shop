...
<div class="row">
    <div class="col-md-9">
        ...
        <div class="box">
            <div class="box-body">
                <?= $form->field($model, 'delivery_list')->listBox(ShopDelivery::listAll(), [
                    'multiple' => true,
                    'size' => 5,
                ]) ?>
            </div>
    ...
    <div class="col-md-3">
        <div class="box">
            <div class="box-body">
                ...
                <?= $form->field($model, 'className')->dropDownList(PaymentsMain::MethodsList(), ['prompt' => Yii::t('backend', 'Customer Class')]) ?>
            </div>
        </div>
        <div class="box">
            <div class="box-body">
